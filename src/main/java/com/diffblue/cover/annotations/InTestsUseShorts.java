...
public @interface InTestsUseShorts {

  /** Collects multiple {@link InTestsUseShorts} annotations. */
  @Retention(RUNTIME)
  @Target({PACKAGE, TYPE, METHOD, PARAMETER})
  @interface Repeatable {

    /**
     * @return the repeated {@link InTestsUseShorts} annotations.
     */
    InTestsUseShorts[] value();
  }

  /**
   * @return {@code short} values that should be tried.
   */
  short[] value() default {};
}
