...
public @interface InTestsUseIntegers {

  /** Collects multiple {@link InTestsUseIntegers} annotations. */
  @Retention(RUNTIME)
  @Target({PACKAGE, TYPE, METHOD, PARAMETER})
  @interface Repeatable {

    /**
     * @return the repeated {@link InTestsUseIntegers} annotations.
     */
    InTestsUseIntegers[] value();
  }

  /**
   * @return {@code int} values that should be tried.
   */
  int[] value() default {};
}
